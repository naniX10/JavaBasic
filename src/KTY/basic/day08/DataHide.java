...
//        System.out.println(two.d);  // default : 다른 패키지라
//        System.out.println(two.e);  // private : 알지?
        System.out.println(two.f);  // public : 알지?
...
class A{
    int a;          // default 접근 지정
    private int b;  // private 접근 지정  다른 클래스에선 참조 못하는듯?
