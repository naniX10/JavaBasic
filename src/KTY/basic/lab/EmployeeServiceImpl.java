...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    // 상수선언
        static final String[] JOBID = {"FI_MGR", "PU_MAN", "AD_VP", "FI_MGR", "ST_MAN" };
    ...
    private EmployeeServiceImpl() {            // << 생성자 만들기!
    }
    ...
    public void newEmployee() {
        ...
        try {
            ...
            EmployeeVO emp = new EmployeeVO(empno,
                    fname, lname, email, phone,hdate);

            // 사원 추가정보를 생성해서 사원 정보로 저장
    ...
    // 사원 기본정보 (사번, 이름, 성, 이메일, 전화번호, 입사일) 등을 리스트형태로 출력
    @Override
    ...
    public void makeExtInfo(EmployeeVO emp) {
        ...
        int sal = rnd.nextInt(MAXSAL) + MINSAL; // 2000~38000 사이 월급
