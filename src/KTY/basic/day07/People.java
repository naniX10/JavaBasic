...
public class People {
    public static void main(String[] args) {
        ...
        // 이렇게 생성된 객체는 독립된 메모리 공각에 저장된
        // 자신만의 변수를 가질 수 있음

        // 일반적인 클래스 구성요소
        // 멤버 변수, 생성자, setter/getter
       ...
       // 고객정보
        ...
        Person p = new Person(); // <<<< 이거 하나로 위에 11줄~15줄에 있는거 설명 가능
    ...
    static class Student {
        ...
        public Student(String stuNum, String name, String address,
                       String birth, String dname, String professor){
